    ...
    def _convert_to_html(self, content: str) -> str:
        ...
        for section in sections:
            ...
            for para in paragraphs:
                    ...
                    formatted_paragraphs.append(f'<p style="margin: 8px 0; padding-left: 15px; color: #000000;">{para}</p>')
else:
                    formatted_paragraphs.append(f'<p style="margin: 10px 0; color: #000000;">{para}</p>')
            html_parts.append('\n'.join(formatted_paragraphs))
        divider = '<table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0"><tr><td style="padding: 30px 0;"><div style="height: 2px; background: linear-gradient(to right, #6000ff, #cc99ff); border-radius: 2px;"></div></td></tr></table>'
